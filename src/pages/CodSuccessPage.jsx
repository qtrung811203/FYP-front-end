      ...
      <Card>
        ...
        <OrderInfo>
          <OrderInfoItem>
            ...
            <OrderInfoValue>{state.order._id}</OrderInfoValue>
          </OrderInfoItem>
          <OrderInfoItem>
            <OrderInfoLabel>Total Amount:</OrderInfoLabel>
            <OrderInfoValue>{state.order.totalPrice}</OrderInfoValue>
          </OrderInfoItem>
          <OrderInfoItem>
            <OrderInfoLabel>Number of Items:</OrderInfoLabel>
            <OrderInfoValue>{state.order.totalItems}</OrderInfoValue>
          </OrderInfoItem>
        </OrderInfo>
        <SmallText>Please check your email for detailed information about your order.</SmallText>
      </Card>
    </PageContainer>
  )
}
